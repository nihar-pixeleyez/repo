            ...
            <div class="max-w-[550px] flex-none w-full bg-white border border-black/10 p-6 sm:p-10 lg:px-10 lg:py-14 rounded-2xl loginform dark:bg-darklight dark:border-darkborder">
                ...
                <form class="space-y-4">
                    ...
                    <div class="ltr:text-right rtl:text-left">
                        <router-link to="/reset-pw" class="text-black dark:text-white">Forgot Password?</router-link>
                    </div>
                ...
                <p class="mt-5 text-center text-muted dark:text-darkmuted">Not a Member yet? <router-link to="/signup" class="text-black dark:text-white">Create an Account</router-link></p>
            </div>
        </div>
        <!-- End Main Content -->
