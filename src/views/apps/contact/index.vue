...
<template>
    <Layout>
        <headTitle title="Contact" items="Apps" />
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-1.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-4 mt-4">
                        <router-link to="/profile" class="btn inline-block py-1 px-3.5 text-[13px] bg-purple border border-purple rounded-md text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85]">Profile</router-link>
                        <router-link to="/chat" class="btn inline-block py-1 px-3.5 text-[13px] dark:text-white dark:hover:text-black border border-light rounded-md text-black transition-all duration-300 hover:bg-light hover:text-black">Chat</router-link>
                    </div>
                </div>
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-2.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-3.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-4.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-5.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-6.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-7.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-8.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-9.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
                ...
                <div class="p-5 bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                    <div class="flex items-center gap-2 mb-4">
                        <div>
                            <img src="@/assets/images/avatar-11.png" class="w-12 h-12 rounded-full" alt="">
                        </div>
                        <div>
