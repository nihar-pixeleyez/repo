<template>
    <Layout>
        <headTitle title="Email" items="Apps" />
        <div class="flex flex-col items-start gap-4 tabs md:flex-row">
            <!-- Tab buttons -->
            <div class="flex flex-col gap-4 min-h-[calc(100vh-212px)]">
                <div class="min-h-[calc(100vh-212px)]">
                    <div x-data="{activeTab:'inbox'}" class="flex flex-col items-start gap-4 tabs md:flex-row">
                        <div class="flex-none w-full md:w-20 xl:w-[200px] dark:bg-darklight dark:border-darkborder overflow-y-auto rounded border border-black/10 p-4 bg-white md:h-[calc(100vh-210px)]">
                            <div class="flex flex-wrap gap-2 tabs-list md:flex-col">
                                <span v-for="(tab, index) in tabs" :key="index">
                                    <button v-if="tab.name === 'compose'" @click="activeTab = tab.name" :class="[activeTab === tab.name]" class="bg-purple text-white px-3 py-2.5 flex items-center gap-3 rounded w-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" :d="tab.path"></path>
                                        </svg>
                                        {{ tab.label }}
                                    </button>
                                    <button v-else @click="activeTab = tab.name" :class="[activeTab === tab.name ? 'text-black dark:text-white bg-light/50 dark:bg-white/5' : 'text-muted dark:text-darkmuted dark:hover:text-white hover:text-black']" class="flex items-center gap-3 px-3 py-2 rounded w-full">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" :d="tab.path"></path>
                                        </svg>
                                        {{ tab.label }}
            ...
            <div class="flex-1 w-full tab-content md:w-auto">
                <template v-if="activeTab === 'compose'">
                    <!-- Inbox content -->
                    <div class="flex flex-col items-start lg:flex-row gap-7">
                        <div class="flex-1 md:h-[calc(100vh-210px)] w-full overflow-y-auto space-y-4">
                            <div class="bg-white border rounded border-black/10 dark:bg-darklight dark:border-darkborder">
                                <div class="py-2.5 px-4 border-b border-black/10 dark:border-darkborder flex flex-wrap items-center gap-y-3 gap-x-12">
                                    <p class="text-muted dark:text-white">TO</p>
                                    <div class="flex flex-wrap gap-2">
                                        <div class="flex gap-2 p-1 rounded cursor-pointer bg-light/20 dark:bg-white/5">
                                            <img class="flex-none object-cover w-6 h-6 overflow-hidden rounded" src="@/assets/images/user.png" alt="" />
                                        ...
                                        <div class="flex gap-2 p-1 rounded bg-light/20 dark:bg-white/5">
                                            <img class="flex-none object-cover w-6 h-6 overflow-hidden rounded-full" src="@/assets/images/slack.png" alt="" />
                                            <div class="flex items-center justify-between flex-1 gap-2">
                                                <p>Slack</p>
                                                <a href="javaScript:;" class="text-muted hover:text-black">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4">
                            ...
                            <div class="p-4 py-2 bg-white border rounded-md border-black/10 dark:bg-darklight dark:border-darkborder">
                                <div class="flex items-center justify-between gap-2">
                                    <div class="flex items-center gap-2">
                                        <div class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded cursor-pointer sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                                <path fill="currentColor" d="M4 8H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V8ZM6 10V20H18V10H6ZM9 12H11V18H9V12ZM13 12H15V18H13V12ZM7 5V3C7 2.44772 7.44772 2 8 2H16C16.5523 2 17 2.44772 17 3V5H22V7H2V5H7ZM9 4V5H15V4H9Z"></path>
                                            </svg>
                                        </div>
                                        <div class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded cursor-pointer sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                                <path fill="currentColor" d="M2.9918 21C2.44405 21 2 20.5551 2 20.0066V3.9934C2 3.44476 2.45531 3 2.9918 3H21.0082C21.556 3 22 3.44495 22 3.9934V20.0066C22 20.5552 21.5447 21 21.0082 21H2.9918ZM20 15V5H4V19L14 9L20 15ZM20 17.8284L14 11.8284L6.82843 19H20V17.8284ZM8 11C6.89543 11 6 10.1046 6 9C6 7.89543 6.89543 7 8 7C9.10457 7 10 7.89543 10 9C10 10.1046 9.10457 11 8 11Z">
                                                </path>
                                            </svg>
                                        </div>
                                        <div class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded cursor-pointer sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                                <path fill="currentColor" d="M14.8287 7.7574L9.1718 13.4143C8.78127 13.8048 8.78127 14.4379 9.1718 14.8285C9.56232 15.219 10.1955 15.219 10.586 14.8285L16.2429 9.17161C17.4144 8.00004 17.4144 6.10055 16.2429 4.92897C15.0713 3.7574 13.1718 3.7574 12.0002 4.92897L6.34337 10.5858C4.39075 12.5384 4.39075 15.7043 6.34337 17.6569C8.29599 19.6095 11.4618 19.6095 13.4144 17.6569L19.0713 12L20.4855 13.4143L14.8287 19.0711C12.095 21.8048 7.66283 21.8048 4.92916 19.0711C2.19549 16.3374 2.19549 11.9053 4.92916 9.17161L10.586 3.51476C12.5386 1.56214 15.7045 1.56214 17.6571 3.51476C19.6097 5.46738 19.6097 8.63321 17.6571 10.5858L12.0002 16.2427C10.8287 17.4143 8.92916 17.4143 7.75759 16.2427C6.58601 15.0711 6.58601 13.1716 7.75759 12L13.4144 6.34319L14.8287 7.7574Z"></path>
                                            </svg>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-2">
                                        <button type="button" class="btn bg-light border border-light rounded-md text-black transition-all duration-300 hover:bg-light/[0.85] hover:border-light/[0.85]">Save draft</button>
                                        <button type="button" class="btn py-2.5 px-3 bg-purple border border-purple rounded-md text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85]">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                ...
                <template v-if="activeTab === 'inbox'">
                    ...
                    <div class="relative flex flex-row items-start gap-4">
                        <div class="lg:max-w-[300px] xl:max-w-[426px] w-full flex-1 flex flex-col gap-2 rounded border border-black/10 dark:bg-darklight dark:border-darkborder bg-white min-h-[calc(100vh-340px)] md:min-h-[calc(100vh-212px)]">
                            <div class="flex items-center justify-between gap-2 px-4 py-2 bg-light/20 dark:bg-white/5">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div class="relative w-full max-w-[160px]">
                                        <input type="text" class="h-10 form-input dark:text-white/80 dark:placeholder:text-white/30 dark:border-darkborder dark:bg-dark dark:focus:border-white/30" placeholder="Search..." required="">
                                    </div>
                                </div>
                                <div class="flex items-center gap-2">
                                    <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                    ...
                                    <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" d="M5.46257 4.43262C7.21556 2.91688 9.5007 2 12 2C17.5228 2 22 6.47715 22 12C22 14.1361 21.3302 16.1158 20.1892 17.7406L17 12H20C20 7.58172 16.4183 4 12 4C9.84982 4 7.89777 4.84827 6.46023 6.22842L5.46257 4.43262ZM18.5374 19.5674C16.7844 21.0831 14.4993 22 12 22C6.47715 22 2 17.5228 2 12C2 9.86386 2.66979 7.88416 3.8108 6.25944L7 12H4C4 16.4183 7.58172 20 12 20C14.1502 20 16.1022 19.1517 17.5398 17.7716L18.5374 19.5674Z"></path>
                                        </svg>
                                    </button>
                                    <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                            ...
                            <div class="space-y-2 py-1.5 px-4 overflow-y-auto">
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/50 dark:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        <div>
                                            <input type="checkbox" class="form-checkbox outborder-purple">
                                        </div>
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/avatar-6.png" alt="" />
                                ...
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        <div>
                                            <input type="checkbox" class="form-checkbox outborder-purple">
                                        </div>
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/slack.png" alt="" />
                                        <div class="flex-1 ltr:text-left rtl:text-right">
                                ...
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        ...
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/avatar-7.png" alt="" />
                                        <div class="flex-1 ltr:text-left rtl:text-right">
                                            <p class="line-clamp-1 dark:text-white">Drew Cano</p>
                                            <p class="text-xs text-muted line-clamp-1">Let's go fishing! - Hey, You wanna join me and Fred at the lake tomorrow? It'll be awesome.</p>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        ...
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/avatar-8.png" alt="" />
                                        <div class="flex-1 ltr:text-left rtl:text-right">
                                            <p class="line-clamp-1 dark:text-white">Orlando Diggs</p>
                                            <p class="text-xs text-muted line-clamp-1">Hey man – Nah man sorry i don't. Should i get it?</p>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        ...
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/behance.png" alt="" />
                                        <div class="flex-1 ltr:text-left rtl:text-right">
                                ...
                                <button @click="selectedMail = true" class="flex items-start w-full gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                    <div class="flex items-center flex-1 gap-2 p-1">
                                        ...
                                        <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/chatgpt.png" alt="" />
                                        <div class="flex-1 ltr:text-left rtl:text-right">
                                    ...
                                    <div>
                                        <p class="flex-none text-xs text-black/40 mb-1.5 dark:text-darkmuted">April 12</p>
                                        <div class="text-muted hover:text-purple">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4 mx-auto">
                                                <path fill="currentColor" d="M12.0006 18.26L4.94715 22.2082L6.52248 14.2799L0.587891 8.7918L8.61493 7.84006L12.0006 0.5L15.3862 7.84006L23.4132 8.7918L17.4787 14.2799L19.054 22.2082L12.0006 18.26Z"></path>
                                            </svg>
                        ...
                        <div class="flex-1 overflow-y-auto md:h-[calc(100vh-212px)] border border-black/10 rounded absolute top-0 left-0 bg-white dark:bg-darklight dark:border-darkborder md:static h-full" :class="!selectedMail ? 'hidden md:block' : ''">
                            <div class="flex items-center gap-3 px-4 py-2 border-b bg-light/20 border-black/10 dark:border-darkborder dark:bg-white/5">
                            ...
                            <div class="rounded pt-10 md:h-[calc(100vh-312px)] overflow-y-auto">
                                <div class="px-10 pb-10">
                                    <img src="@/assets/images/slack-logo.svg" alt="slack logo" class="mb-7" />
                                    <h3 class="text-2xl font-semibold text-black dark:text-white mb-7">Invite your team</h3>
                                    <p class="mb-7 dark:text-darkmuted">Slack is most useful when your whole team can join the conversation. Try adding people to Sliced Admin Community to start being more productive together!</p>
                                    <a href="javaScript:;" class="btn bg-black dark:bg-white dark:text-black dark:border-white dark:hover:bg-white/85 dark:hover:border-white/85 border border-black rounded-md text-white transition-all duration-300 hover:bg-black/[0.85] hover:border-black/[0.85] inline-block mb-7">Invite People</a>
                                    <img src="@/assets/images/mail-banner.png" alt="banner" class="w-full mb-7" />
                                    <div class="flex flex-col items-center justify-between gap-6 lg:flex-row mb-7">
                                        <div class="flex items-start flex-1 gap-2 p-1">
                                            <img class="flex-none object-cover w-10 h-10 overflow-hidden rounded-full" src="@/assets/images/logo-icon.svg" alt="" />
                                        ...
                                        <a href="javaScript:;" class="inline-block text-black transition-all duration-300 border rounded-md btn border-light dark:text-white dark:hover:text-black hover:bg-light hover:text-black">Sign In</a>
                                    </div>
                                    <p class="text-center text-muted dark:text-white">&copy;2023 Slack Technologies, LLC, a Salesforce company.</p>
                                </div>
                                <div class="flex justify-end gap-4 px-4 py-2 border-t bg-light/20 border-black/10 dark:border-darkborder dark:bg-white/5">
                                    <a href="javaScript:;" class="btn bg-light border border-light rounded-md text-black transition-all duration-300 hover:bg-light/[0.85] hover:border-light/[0.85] flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" d="M5.82843 6.99955L8.36396 9.53509L6.94975 10.9493L2 5.99955L6.94975 1.0498L8.36396 2.46402L5.82843 4.99955H13C17.4183 4.99955 21 8.58127 21 12.9996C21 17.4178 17.4183 20.9996 13 20.9996H4V18.9996H13C16.3137 18.9996 19 16.3133 19 12.9996C19 9.68584 16.3137 6.99955 13 6.99955H5.82843Z"></path>
                                        </svg>
                                        <span>Reply</span>
                                    </a>
                                    <a href="javaScript:;" class="btn bg-purple border border-purple rounded-md text-white transition-all duration-300 hover:bg-purple/[0.85] hover:border-purple/[0.85] flex items-center gap-2">
                                        <span>Forward</span>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" d="M18.1716 6.99955H11C7.68629 6.99955 5 9.68584 5 12.9996C5 16.3133 7.68629 18.9996 11 18.9996H20V20.9996H11C6.58172 20.9996 3 17.4178 3 12.9996C3 8.58127 6.58172 4.99955 11 4.99955H18.1716L15.636 2.46402L17.0503 1.0498L22 5.99955L17.0503 10.9493L15.636 9.53509L18.1716 6.99955Z"></path>
                                        </svg>
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="flex-1 overflow-y-auto md:h-[calc(100vh-212px)] border border-black/10 rounded absolute top-0 left-0 bg-white dark:bg-darklight dark:border-darkborder md:static h-full" :class="!selectedMail ? 'hidden md:block' : ''">
                            ...
                            <div class="rounded pt-10 md:h-[calc(100vh-312px)] overflow-y-auto">
                                <div class="px-10 pb-10">
                                    ...
                                    <h3 class="text-2xl font-semibold text-black dark:text-white mb-7">Invite your team</h3>
                                    <p class="mb-7 dark:text-darkmuted">Slack is most useful when your whole team can join the conversation. Try adding people to Sliced Admin Community to start being more productive together!</p>
                                    <a href="javaScript:;" class="btn bg-black dark:bg-white dark:text-black dark:border-white dark:hover:bg-white/[0.85] dark:hover:border-white/[0.85] border border-black rounded-md text-white transition-all duration-300 hover:bg-black/[0.85] hover:border-black/[0.85] inline-block mb-7">Invite People</a>
                                    <img src="@/assets/images/mail-banner.png" alt="banner" class="w-full mb-7" />
                                    <div class="flex flex-col items-center justify-between gap-6 lg:flex-row mb-7">
                                        <div class="flex items-start flex-1 gap-2 p-1">
                                            <img class="flex-none object-cover w-10 h-10 overflow-hidden rounded-full" src="@/assets/images/logo-icon.svg" alt="" />
                                ...
                                <div class="flex gap-4 px-4 py-2 border-t ltr:justify-end rtl:justify-start bg-light/20 border-black/10 dark:border-darkborder dark:bg-white/5">
                                    <a href="javaScript:;" class="btn bg-light border border-light rounded-md text-black transition-all duration-300 hover:bg-light/[0.85] hover:border-light/[0.85] flex items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" d="M5.82843 6.99955L8.36396 9.53509L6.94975 10.9493L2 5.99955L6.94975 1.0498L8.36396 2.46402L5.82843 4.99955H13C17.4183 4.99955 21 8.58127 21 12.9996C21 17.4178 17.4183 20.9996 13 20.9996H4V18.9996H13C16.3137 18.9996 19 16.3133 19 12.9996C19 9.68584 16.3137 6.99955 13 6.99955H5.82843Z"></path>
                                        </svg>
...
const init = (el) => {
    if (el.value) {
                ...
                <head>
                    <style>
                        *, ::after, ::before {box-sizing: border-box;}
                        ...
                        body {margin: 0px; padding: 1rem 0.5rem; font-family: 'Cerebri Sans';}
        ...
        `);
        doc.close();
        el.value.contentDocument.designMode = "on";
    }
};
...
const tabs = [
    { name: 'compose', label: 'Compose', path: 'M16.7574 2.99666L14.7574 4.99666H5V18.9967H19V9.2393L21 7.2393V19.9967C21 20.5489 20.5523 20.9967 20 20.9967H4C3.44772 20.9967 3 20.5489 3 19.9967V3.99666C3 3.44438 3.44772 2.99666 4 2.99666H16.7574ZM20.4853 2.09717L21.8995 3.51138L12.7071 12.7038L11.2954 12.7062L11.2929 11.2896L20.4853 2.09717Z' },
    { name: 'inbox', label: 'Inbox', path: 'M16.1 3C16.0344 3.32311 16 3.65753 16 4C16 4.34247 16.0344 4.67689 16.1 5H4.51146L12.0619 11.662L17.1098 7.14141C17.5363 7.66888 18.0679 8.10787 18.6728 8.42652L12.0718 14.338L4 7.21594V19H20V8.89998C20.3231 8.96557 20.6575 9 21 9C21.3425 9 21.6769 8.96557 22 8.89998V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H16.1ZM21 1C22.6569 1 24 2.34315 24 4C24 5.65685 22.6569 7 21 7C19.3431 7 18 5.65685 18 4C18 2.34315 19.3431 1 21 1Z' },
    { name: 'sent', label: 'Sent', path: 'M21.7264 2.95706L16.2732 22.0433C16.1222 22.5718 15.7976 22.5958 15.5561 22.1127L10.9998 13.0002L1.92266 9.36931C1.41298 9.16544 1.41929 8.86034 1.9567 8.6812L21.0429 2.31913C21.5714 2.14297 21.8745 2.43878 21.7264 2.95706ZM19.0351 5.0966L6.81197 9.17097L12.4486 11.4256L15.4893 17.507L19.0351 5.0966Z' },
    { name: 'draft', label: 'Draft', path: 'M20 2C20.5523 2 21 2.44772 21 3V6.757L19 8.757V4H5V20H19V17.242L21 15.242V21C21 21.5523 20.5523 22 20 22H4C3.44772 22 3 21.5523 3 21V3C3 2.44772 3.44772 2 4 2H20ZM21.7782 8.80761L23.1924 10.2218L15.4142 18L13.9979 17.9979L14 16.5858L21.7782 8.80761ZM13 12V14H8V12H13ZM16 8V10H8V8H16Z' },
    { name: 'spam', label: 'Spam', path: 'M17.5 2.5L23 12L17.5 21.5H6.5L1 12L6.5 2.5H17.5ZM16.3469 4.5H7.65311L3.311 12L7.65311 19.5H16.3469L20.689 12L16.3469 4.5ZM11 15H13V17H11V15ZM11 7H13V13H11V7Z' },
    { name: 'trash', label: 'Trash', path: 'M7 4V2H17V4H22V6H20V21C20 21.5523 19.5523 22 19 22H5C4.44772 22 4 21.5523 4 21V6H2V4H7ZM6 6V20H18V6H6ZM9 9H11V17H9V9ZM13 9H15V17H13V9Z' },
    { name: 'archive', label: 'Archive', path: 'M20 3L22 7V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V7.00353L4 3H20ZM20 9H4V19H20V9ZM13 10V14H16L12 18L8 14H11V10H13ZM18.7639 5H5.23656L4.23744 7H19.7639L18.7639 5Z' },
];
