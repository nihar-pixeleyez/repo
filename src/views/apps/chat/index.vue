...
const dropdownItems = ["New Groupe", "Starred Massage", "Setting"];
const dropdownItems2 = ["View Profile", "Media, links and docs", "Mute notification","Setting"];

</script>

<template>
    <Layout>
        <headTitle title="Chat" items="Apps" />

        <!-- Start All Card -->
        <div class="flex flex-col gap-4 min-h-[calc(100vh-212px)]">
            <div class="relative flex flex-row items-start gap-4" x-data="{selectedchat: false}">
                <div class="lg:max-w-[326px] w-full bg-white flex-1 flex flex-col gap-2 border border-black/10 dark:bg-darklight dark:border-darkborder rounded">
                    <div class="flex items-center justify-between gap-2 px-4 py-2 bg-light/20 dark:bg-white/5">
                        <div class="relative w-full max-w-[160px]">
                            <input type="text" id="voice-search" class="h-10 form-input dark:text-white/80 dark:placeholder:text-white/30 dark:border-darkborder dark:bg-dark dark:focus:border-white/30" placeholder="Search..." required="">
                        </div>
                        <div class="flex items-center gap-2">
                            <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/50">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                    <path fill="currentColor" d="M3 2H19.0049C20.1068 2 21 2.89821 21 3.9908V20.0092C21 21.1087 20.1074 22 19.0049 22H3V2ZM7 4H5V20H7V4ZM9 20H19V4H9V20ZM11 16C11 14.3431 12.3431 13 14 13C15.6569 13 17 14.3431 17 16H11ZM14 12C12.8954 12 12 11.1046 12 10C12 8.89543 12.8954 8 14 8C15.1046 8 16 8.89543 16 10C16 11.1046 15.1046 12 14 12ZM22 6H24V10H22V6ZM22 12H24V16H22V12Z"></path>
                                </svg>
                            </button>
                    ...
                    <ul class="space-y-2 h-[calc(100vh-277px)] px-4 overflow-y-auto">
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/50 dark:bg-white/10 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-center flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-6.png" alt="">
                                    </div>
                        ...
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    ...
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                                        <p class="line-clamp-1 dark:text-white">Sarah Jackson, Michael Brown, Christopher Lee</p>
                        ...
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="relative flex items-center justify-start text-black w-9 h-9">
                                        <img class="absolute top-0 left-0 object-cover w-5 h-5 overflow-hidden rounded-full ring-2 ring-white" src="@/assets/images/avatar-17.png" alt="">
                                        <img class="absolute top-0 right-0 object-cover w-5 h-5 overflow-hidden rounded-full ring-2 ring-white" src="@/assets/images/avatar-5.png" alt="">
                                        <img class="absolute bottom-0 left-0 object-cover w-5 h-5 overflow-hidden rounded-full ring-2 ring-white" src="@/assets/images/avatar-26.png" alt="">
                                        <span class="flex justify-center items-center w-5 h-5 absolute bottom-0 right-0 text-center rounded-full object-cover bg-light text-[8px] ring-2 ring-white">3</span>
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                                ...
                                <div class="ltr:text-right rtl:text-left">
                                    <p class="flex-none text-xs text-muted mb-1.5">Mar 12</p><span class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-purple text-white">12</span>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-5.png" alt="">
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                        ...
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-11.png" alt="">
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                        ...
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-13.png" alt="">
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                                ...
                                <div class="ltr:text-right rtl:text-left">
                                    <p class="flex-none text-xs text-muted mb-1.5">Mar 9</p><span class="inline-block items-center rounded text-xs justify-center px-1.5 py-0.5 bg-purple text-white">12</span>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-10.png" alt="">
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                        ...
                        <li>
                            <a href="javascript:;" @click="selectedchat = true" class="flex items-start gap-2 p-2 transition-all duration-300 rounded bg-light/20 dark:bg-white/5 dark:hover:bg-white/10 hover:border-transparent hover:bg-light/50">
                                <div class="flex items-start flex-1 gap-2 p-1">
                                    <div class="w-9 h-9">
                                        <img class="flex-none object-cover overflow-hidden rounded-full" src="@/assets/images/avatar-24.png" alt="">
                                    </div>
                                    <div class="flex-1 ltr:text-left rtl:text-right">
                                        <p class="line-clamp-1 dark:text-white">Catherine</p>
                                        <p class="text-xs text-muted line-clamp-1">Let's talk about the search box interaction again</p>
                                    </div>
                                </div>
                                <div class="ltr:text-right rtl:text-left">
                    ...
                    <div class="border rounded border-black/10 dark:border-darkborder dark:bg-darklight">
                        <div class="flex justify-between gap-3 p-3 border-b border-black/10 dark:border-darkborder">
                            <div class="flex items-center gap-2 p-1">
                                ...
                                <img class="flex-none object-cover overflow-hidden rounded-full w-9 h-9" src="@/assets/images/user.png" alt="">
                                <div>
                            ...
                            <div class="flex items-center gap-2">
                                <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 bg-transparent rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/40">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                        ...
                        <div class="">
                            <div class="flex items-center gap-4 px-4 py-2 bg-light/20 dark:bg-white/5">
                                <div class="flex items-center flex-none gap-2">
                                    <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 bg-transparent rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/40">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
                                            <path fill="currentColor" d="M11.9998 3C10.3429 3 8.99976 4.34315 8.99976 6V10C8.99976 11.6569 10.3429 13 11.9998 13C13.6566 13 14.9998 11.6569 14.9998 10V6C14.9998 4.34315 13.6566 3 11.9998 3ZM11.9998 1C14.7612 1 16.9998 3.23858 16.9998 6V10C16.9998 12.7614 14.7612 15 11.9998 15C9.23833 15 6.99976 12.7614 6.99976 10V6C6.99976 3.23858 9.23833 1 11.9998 1ZM3.05469 11H5.07065C5.55588 14.3923 8.47329 17 11.9998 17C15.5262 17 18.4436 14.3923 18.9289 11H20.9448C20.4837 15.1716 17.1714 18.4839 12.9998 18.9451V23H10.9998V18.9451C6.82814 18.4839 3.51584 15.1716 3.05469 11Z"></path>
                                        </svg>
                                    </button>
                                    <button type="button" class="flex items-center justify-center w-6 h-6 text-black transition-all duration-300 bg-transparent rounded sm:w-9 sm:h-9 dark:text-darkmuted dark:hover:text-white dark:hover:bg-white/5 hover:bg-light/40">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
