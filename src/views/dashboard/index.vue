...
import { userChartOptions, usersByDevice, ChartOptions, ChartOptions2, ChartOptions3 } from './chart/chart.js';
...
<template>
    <Layout>
        <headTitle title="Dashboard" items="Sliced" />
        <!-- Start All Card -->
        <div class="flex flex-col gap-4 min-h-[calc(100vh-212px)]">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
                <div class="flex items-center justify-between gap-6 p-5 bg-white border rounded dark:bg-darklight dark:border-darkborder border-black/10">
                    ...
                    <div>
                        <apexchart type="line" height="60" :options="ChartOptions" :series="ChartOptions.series"></apexchart>
                    </div>
                </div>
                <div class="flex items-center justify-between gap-6 p-5 bg-white border rounded dark:bg-darklight dark:border-darkborder border-black/10">
                    <div>
                    ...
                    <div>
                        <apexchart type="line" height="60" :options="ChartOptions3" :series="ChartOptions3.series"></apexchart>
                    </div>
                </div>
                <div class="flex items-center justify-between gap-6 p-5 bg-white border rounded dark:bg-darklight dark:border-darkborder border-black/10">
                    <div>
                ...
                <div class="flex items-center justify-between gap-6 p-5 bg-white border rounded dark:bg-darklight dark:border-darkborder border-black/10">
                    ...
                    <div>
                        <apexchart type="line" height="60" :options="ChartOptions2" :series="ChartOptions2.series"></apexchart>
                    </div>
                </div>
            </div>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
                <div class="gap-6 p-5 bg-white border rounded dark:bg-darklight dark:border-darkborder md:col-span-2 xl:col-span-2 border-black/10">
                    <div class="flex items-center justify-between gap-4 mb-4">
                        <p class="text-base font-semibold text-black dark:text-white/80 !leading-8">Total Revenue</p>
                        <div>
                        ...
                        <table class="min-w-[640px] w-full">
                            ...
                            <tbody>
                                <tr class="text-muted">
                                    ...
                                    <td>55</td>
                                    <td>2952</td>
                                    <td>27% <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">3.8%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>http://google.com</td>
                                    <td>229</td>
                                    <td>2392</td>
                                    <td>65% <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">7.9%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>http://facebook.com/Index.html</td>
                                    <td>12</td>
                                    <td>2792</td>
                                    <td>37% <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">19.8%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>http://twitter.com</td>
                                    <td>239</td>
                                    <td>6534</td>
                                    <td>74% <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">23.3%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>http://github.com/Index.html</td>
                                    <td>53</td>
                                    <td>3434</td>
                                    <td>71% <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">46.2%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>http://instagram.com</td>
                                    <td>65</td>
                                    <td>123</td>
                                    <td>69% <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">6.89%</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="min-w-[640px] w-full">
                            ...
                            <tbody>
                                <tr class="text-muted">
                                    ...
                                    <td>Desktop</td>
                                    <td>18</td>
                                    <td>2.3K <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">3.8%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>United States</td>
                                    <td>Mobile</td>
                                    <td>24 - 36</td>
                                    <td>879 <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">7.9%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>Germany</td>
                                    <td>Tablet</td>
                                    <td>50</td>
                                    <td>340 <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">19.8%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>United Kingdom</td>
                                    <td>Desktop</td>
                                    <td>24 - 36</td>
                                    <td>5.4K <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">23.3%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>India</td>
                                    <td>Tablet</td>
                                    <td>18</td>
                                    <td>1.3K <span class="px-1 text-xs font-bold rounded bg-success/10 text-success">46.2%</span></td>
                                </tr>
                                <tr class="text-muted">
                                    <td>Singapore</td>
                                    <td>Mobile</td>
                                    <td>18 - 24</td>
                                    <td>699 <span class="px-1 text-xs font-bold rounded bg-danger/10 text-danger">6.89%</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
