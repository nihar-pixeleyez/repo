<template>
  <div class="bg-white dark:bg-darklight dark:border-darkborder flex gap-4 lg:z-10 items-center justify-between px-4 h-[60px] border-b border-black/10 detached-topbar relative">
    <div class="flex items-center flex-1 gap-2 sm:gap-4">
      <button type="button" class="text-black dark:text-white/80" @click="toggleSidebarCollapse('toggle-sidebar')">
    ...
    <div class="flex items-center gap-4">
      ...
      <!-- Light & Dark -->
      <div>
        <a href="#" class="text-black" v-if="mode === 'light'" @click="toggleMode('dark')">
        ...
        <a href="#" class="text-black dark:text-white/80" v-else @click="toggleMode('light')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
...
function toggleSidebarCollapse(newSize) {
  document.body.classList.toggle(newSize);
}
</script>
...
const toggleSidebar = () => {
  ...
  document.querySelector("#sidebarOverlay").classList.toggle('hidden');
};
...
<template>
  <div class="bg-white dark:bg-darklight dark:border-darkborder flex gap-4 lg:z-10 items-center justify-between px-4 h-[60px] border-b border-black/10 detached-topbar relative">
    <div class="flex items-center flex-1 gap-2 sm:gap-4">
      <button type="button" class="text-black dark:text-white/80" @click="toggleSidebar()">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 h-6">
          <path d="M3 4H21V6H3V4ZM3 11H15V13H3V11ZM3 18H21V20H3V18Z" fill="currentColor"></path>
        </svg>
      </button>
    ...
    <div class="flex items-center gap-4">
      <div class="h-5" x-data="{ fullScreen: false }">
        <button class="text-black dark:text-white/80" x-cloak @click="toggleFullScreen()">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 h-5">
            <path v-if="!fullScreen" d="M16 3H22V9H20V5H16V3ZM2 3H8V5H4V9H2V3ZM20 19V15H22V21H16V19H20ZM4 19H8V21H2V15H4V19Z" fill="currentColor"></path>
            <path v-else d="M18 7H22V9H16V3H18V7ZM8 9H2V7H6V3H8V9ZM18 17V21H16V15H22V17H18ZM8 15V21H6V17H2V15H8Z" fill="currentColor"></path>
          </svg>
        </button>
      </div>
      <div>
      ...
      <div class="h-5 notification" x-data="dropdown" @click.outside="open = false">
        ...
        <div class="noti-area" x-cloak x-show="open" x-transition x-transition.duration.300ms>
          <h4 class="text-black dark:text-white/80 px-2 py-2.5 border-b border-black/10 flex items-center gap-2">Notification <span class="inline-block bg-purple/10 text-purple text-[10px] p-1 leading-none rounded">32</span></h4>
          <ul class="overflow-y-auto max-h-56 ">
            <li>
              <div class="flex gap-2 cursor-pointer group" x-show="showElement" x-data="{ showElement: true }" x-transition x-transition.duration.300ms>
                ...
                <div class="relative flex-1">
                  <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[185px] text-black dark:text-white ltr:pr-4 rtl:pl-4">Edited the details of Project</p>
                  <p class="text-xs text-black/40 dark:text-darkmuted">5m ago</p>
                  <button type="button" x-on:click="showElement = false" class="absolute hidden transition-all duration-300 rotate-0 ltr:right-0 rtl:left-0 top-1 dark:text-white/80 group-hover:block hover:opacity-80 hover:rotate-180">
            ...
            <li>
              <div class="flex gap-2 cursor-pointer group" x-show="showElement" x-data="{ showElement: true }" x-transition x-transition.duration.300ms>
                ...
                <div class="relative flex-1">
                  <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[185px] text-black dark:text-white ltr:pr-4 rtl:pl-4">Released a new version</p>
                  <p class="text-xs text-black/40 dark:text-darkmuted">5m ago</p>
                  <button type="button" x-on:click="showElement = false" class="absolute hidden transition-all duration-300 rotate-0 ltr:right-0 rtl:left-0 top-1 dark:text-white/80 group-hover:block hover:opacity-80 hover:rotate-180">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3.5 h-3.5">
                      <path d="M12.0007 10.5865L16.9504 5.63672L18.3646 7.05093L13.4149 12.0007L18.3646 16.9504L16.9504 18.3646L12.0007 13.4149L7.05093 18.3646L5.63672 16.9504L10.5865 12.0007L5.63672 7.05093L7.05093 5.63672L12.0007 10.5865Z" fill="currentColor"></path>
            ...
            <li>
              <div class="flex gap-2 cursor-pointer group" x-show="showElement" x-data="{ showElement: true }" x-transition x-transition.duration.300ms>
                ...
                <div class="relative flex-1">
                  <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[185px] text-black dark:text-white ltr:pr-4 rtl:pl-4">Submitted a bug</p>
                  <p class="text-xs text-black/40 dark:text-darkmuted">5m ago</p>
                  <button type="button" x-on:click="showElement = false" class="absolute hidden transition-all duration-300 rotate-0 ltr:right-0 rtl:left-0 top-1 dark:text-white/80 group-hover:block hover:opacity-80 hover:rotate-180">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3.5 h-3.5">
                      <path d="M12.0007 10.5865L16.9504 5.63672L18.3646 7.05093L13.4149 12.0007L18.3646 16.9504L16.9504 18.3646L12.0007 13.4149L7.05093 18.3646L5.63672 16.9504L10.5865 12.0007L5.63672 7.05093L7.05093 5.63672L12.0007 10.5865Z" fill="currentColor"></path>
            ...
            <li>
              <div class="flex gap-2 cursor-pointer group" x-show="showElement" x-data="{ showElement: true }" x-transition x-transition.duration.300ms>
                ...
                <div class="relative flex-1">
                  <p class="whitespace-nowrap overflow-hidden text-ellipsis w-[185px] text-black dark:text-white ltr:pr-4 rtl:pl-4">Modified A data in Page</p>
                  <p class="text-xs text-black/40 dark:text-darkmuted">5m ago</p>
                  <button type="button" x-on:click="showElement = false" class="absolute hidden transition-all duration-300 rotate-0 ltr:right-0 rtl:left-0 top-1 dark:text-white/80 group-hover:block hover:opacity-80 hover:rotate-180">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-3.5 h-3.5">
                      <path d="M12.0007 10.5865L16.9504 5.63672L18.3646 7.05093L13.4149 12.0007L18.3646 16.9504L16.9504 18.3646L12.0007 13.4149L7.05093 18.3646L5.63672 16.9504L10.5865 12.0007L5.63672 7.05093L7.05093 5.63672L12.0007 10.5865Z" fill="currentColor"></path>
      ...
      <div class="profile" x-data="dropdown" @click.outside="open = false">
        <button type="button" class="flex items-center gap-1.5 xl:gap-0 dark:text-white/80" @click="toggle()">
          ...
          <span class="hidden fw-medium xl:block dark:text-white/80">Stevens L.</span>
        ...
        <ul x-cloak x-show="open" x-transition x-transition.duration.300ms>
          ...
          <li>
            <a href="javaScript:;" class="flex items-center gap-2 text-black dark:text-white">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-4 h-4">
